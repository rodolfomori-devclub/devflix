...
const WHATSAPP_SUPPORT_URL =
  'https://api.whatsapp.com/send?phone=551151925789&text=Ol%C3%A1,%20tudo%20bem%20?%20Preciso%20de%20ajuda%20do%20suporte';
...
const SupportBubble = () => {
  return (
    <a
      ...
      // z-[60] keeps it above FloatingWhatsAppButton (z-50), which shares this corner
      className="fixed bottom-6 right-6 z-[60] bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg transition-colors duration-300"
